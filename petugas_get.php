...
$sql = mysql_query("SELECT users.*,posyandu.* FROM users,posyandu WHERE users.id_posyandu = posyandu.id_pos && users.id_posyandu && id_role = 2 ORDER BY id_users DESC")or die(mysql_error());
//variable array
$response = array();
